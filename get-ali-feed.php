...
/*
1) API FEED
configure the API's request URL to return a JSON feed of products in the women's apparel category that perhaps have an evaluationScore of 4+ and a commissionRate of 4%+. From the feed, we'd grab the fields for product title, product image & URL for product page on AliExpress.

Sample of the Request URL:
3-step process:
...
$feedFile = 'alifeed.'.$apiName.'.categoryId_'.$options['categoryId'].'.'.date('Y-m-d');
